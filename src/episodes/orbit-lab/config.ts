...
export const orbitLabConfig: EpisodeConfig = {
  ...
  parameters: [
    ...
    },
    {
      ...
      step: 1,
      unit: '\u00B0',
      description: 'Direction of initial velocity',
    },
    {
      id: 'orbit-altitude',
      ...
      step: 10000,
      unit: 'm',
      description: 'Starting height above the surface',
    },
    {
      id: 'show-trail',
      label: 'Show Trail',
  ...
  missions: [
    {
      ...
      hints: [
        'Try adjusting the launch speed. Too slow and you fall, too fast and you fly away.',
        'For a circular orbit at 400km altitude, you need about 7,672 m/s.',
        'The orbital velocity formula is v = \u221A(GM/r). Try plugging in the numbers!',
      ],
    ...
    },
    {
      ...
      hints: [
        'Geostationary orbit is at about 35,786 km altitude.',
        'You need to match the orbital velocity at that altitude.',
        'At GEO altitude, orbital velocity is about 3,075 m/s.',
      ],
      successMessage:
